...
export const RecomendationCategorySection = ({ data }: { data: any }) => {
    return (
        <section
            id="category"
            ...
            <div className="container mx-auto max-w-7xl px-6">
                ...
                >
                    {data?.map((item: any, i: number) => (
                        <SwiperSlide key={i}>
                            <RecomendationCategoryItemSection
                                item={item}
                                index={i}
                            />
                        </SwiperSlide>
...
export const RecomendationCategoryItemSection = ({
    item,
    index,
}: {
    item: any;
            ...
            <div className="flex h-full min-h-155 flex-col overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-sm transition-all duration-300 hover:-translate-y-2 hover:border-emerald-200 hover:shadow-2xl">
                ...
                <div className="flex flex-1 flex-col p-7">
                    <div className="flex flex-col space-y-2">
                        ...
                        <div className="description mt-4 line-clamp-3 text-sm leading-relaxed text-slate-600">
