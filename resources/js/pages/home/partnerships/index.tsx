            ...
            <div className="mx-auto grid max-w-7xl gap-12 px-6 lg:grid-cols-[0.95fr_1.05fr] lg:items-center">
                <div>
                    ...
                    <p className="mt-6 max-w-2xl text-lg leading-relaxed text-white/85">
                        Ajukan kolaborasi CSR, sponsor program, dukungan event,
                        atau kerja sama komunitas untuk memperluas manfaat
                ...
                <div className="rounded-3xl bg-white p-6 text-slate-900 shadow-2xl md:p-8">
                    <div className="mb-6">
                        ...
                        <p className="mt-2 text-sm leading-relaxed text-slate-600">
                            Lengkapi data berikut agar tim kami bisa memahami
                            kebutuhan kerja sama dengan lebih tepat.
                        </p>
                    </div>
                    <PartnershipForm />
                </div>
